...
ENEMY_red = pygame.image.load("images/enemy_red.png")
ENEMY_green = pygame.image.load("images/enemy_green.png")
ENEMY_blue = pygame.image.load("images/enemy_blue.png")
ENEMY_yellow = pygame.image.load("images/enemy_yellow.png")
ENEMY_purple = pygame.image.load("images/enemy_purple.png")
ENEMY_orange = pygame.image.load("images/enemy_orange.png")

LASER_red = pygame.image.load("images/laser_red.png")
LASER_green = pygame.image.load("images/laser_green.png")
LASER_blue = pygame.image.load("images/laser_blue.png")
LASER_yellow = pygame.image.load("images/laser_yellow.png")
LASER_purple = pygame.image.load("images/laser_purple.png")
LASER_orange = pygame.image.load("images/laser_orange.png")
...
EXPLOSIONS = *(pygame.image.load(f"images/explosion{i + 1}.png") for i in range(16)),

# music and sound
laser_player = mixer.Sound("music/laser_player.wav")
laser_enemy = mixer.Sound("music/laser_enemy.wav")
explode_player = mixer.Sound("music/explode_player.wav")
explode_enemy = mixer.Sound("music/explode_enemy.wav")
health_lost = mixer.Sound("music/health_lost.wav")
gain_player = mixer.Sound("music/coin_gain.wav")
...
def main():
    ...
    while True:
        ...
        if not (lives and player.health):
            ...
            stable = 10
            player.img = pygame.transform.scale(EXPLOSIONS[explosion_timer // stable], (80, 80))
